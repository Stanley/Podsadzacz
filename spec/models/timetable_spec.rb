...
describe Timetable do
  ...
  context "creating valid new" do
    ...
    before(:all) do
      @line = Line.create :id => 1, :no => 0, :begin_date => Date.parse("Mon")
    end
    ...
    before do # 4[BRONOWICE MAŁE]: Struga
      ...
      @timetable.times[0] = [28, 20, 15, 18, 9, 7, 10, 10, 10, 10, 10, 10, 10, 9, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,10, 10, 10, 10, 10, 10, 10, 10, 11, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 9, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 11, 20, 20, 20, 20, 20, 20, 20, 20, 20]
      @timetable.times[1] = [20, 20, 20, 20, 20, 20, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 30, nil, 30, 30, 30, 31, 31, 29, nil, nil]
      @timetable.times[2] = [57, 30, 30, 30, 30, 20, 24, 20, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 30, nil, 30, 30, 30, 31, 31, 29, nil, nil]
      @timetable.save
    end
  ...
  context "creating valid new with description" do
    ...
    before do # 16[WALCOWNIA]: Dunikowskiego
      ...
      @timetable.times[0] = [56, 10, 10, 9, 11, 10, 9, 11, 10, 12, 9, 12, 8, 10, 10, 20, 10, 10, 11, 15, 10, 15, 10, 10, 20, 20, 20, 20, 20, 20, 20, 20, 20, 19, 20, 11, 10, 10, 10, 13, 15, 10, 10, 10, 10, 14, 13, 13, 12, 8, 10, 10, 20, 12, 10, 10, 16, 7, 14, 20, 20, 15, 20, 20, 20, 25, 15, 21, 20, 11, 9, 20, 21, 20, 19, 19, 28]
      @timetable.times[1] = [71, 25, 19, 20, 20, 20, 22, 36, 20, 20, 20, 28, 32, 20, 20, 20, 20, 27, 33, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 22, 38, 20, 20, 20, 20, 20, 40, 20, 20, 20, 20, 30, 31, 30, 30, 30, 30]
      @timetable.times[2] = [67, 27, 30, 30, 30, 30, 31, 28, 20, 21, 39, 20, 20, 20, 20, 27, 33, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 22, 38, 20, 20, 20, 20, 20, 35, 25, 20, 20, 20, 30, 31, 30, 30, 30, 30]
      @timetable.save
    end
